...
var queryUrl = baseUrl + "api/picturetype/findPage";
var addUrl = baseUrl + "api/picturetype/add";
var modUrl = baseUrl + "api/picturetype/update";
var delUrl = baseUrl + "api/picturetype/delete";
