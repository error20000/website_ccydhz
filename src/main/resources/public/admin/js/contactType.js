...
var queryUrl = baseUrl + "api/contacttype/findPage";
var addUrl = baseUrl + "api/contacttype/add";
var modUrl = baseUrl + "api/contacttype/update";
var delUrl = baseUrl + "api/contacttype/delete";
