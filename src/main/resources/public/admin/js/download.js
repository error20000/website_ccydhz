...
var queryUrl = baseUrl + "api/download/findPage";
var addUrl = baseUrl + "api/download/add";
var modUrl = baseUrl + "api/download/update";
var delUrl = baseUrl + "api/download/delete";
var uploadUrl = baseUrl + "api/file/uploadImg";
var typeUrl = baseUrl + "api/downloadtype/findAll";
