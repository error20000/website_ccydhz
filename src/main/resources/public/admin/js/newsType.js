...
var queryUrl = baseUrl + "api/newstype/findPage";
var addUrl = baseUrl + "api/newstype/add";
var modUrl = baseUrl + "api/newstype/update";
var delUrl = baseUrl + "api/newstype/delete";
...
var myvue = new Vue({
		...
		methods: {
			...
			handleAddUpload: function(res){
				if(res.code > 0){
					this.addForm.icon = res.data.path;
				}else{
					this.$message({
						message: res.msg,
						type: 'warning'
			...
			handleEditUpload: function(res){
				if(res.code > 0){
					this.editForm.icon = res.data.path;
				}else{
					this.$message({
						message: res.msg,
						type: 'warning'
