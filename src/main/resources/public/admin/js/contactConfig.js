...
var queryUrl = baseUrl + "api/contactconfig/findPage";
var addUrl = baseUrl + "api/contactconfig/add";
var modUrl = baseUrl + "api/contactconfig/update";
var delUrl = baseUrl + "api/contactconfig/delete";
