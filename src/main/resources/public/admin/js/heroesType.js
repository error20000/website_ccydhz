...
var queryUrl = baseUrl + "api/heroestype/findPage";
var addUrl = baseUrl + "api/heroestype/add";
var modUrl = baseUrl + "api/heroestype/update";
var delUrl = baseUrl + "api/heroestype/delete";
