...
var queryUrl = baseUrl + "api/recommendtype/findPage";
var addUrl = baseUrl + "api/recommendtype/add";
var modUrl = baseUrl + "api/recommendtype/update";
var delUrl = baseUrl + "api/recommendtype/delete";
