...
var queryUrl = baseUrl + "api/downloadtype/findPage";
var addUrl = baseUrl + "api/downloadtype/add";
var modUrl = baseUrl + "api/downloadtype/update";
var delUrl = baseUrl + "api/downloadtype/delete";
