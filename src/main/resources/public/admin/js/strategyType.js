...
var queryUrl = baseUrl + "api/strategytype/findPage";
var addUrl = baseUrl + "api/strategytype/add";
var modUrl = baseUrl + "api/strategytype/update";
var delUrl = baseUrl + "api/strategytype/delete";
