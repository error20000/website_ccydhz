...
var myvue = new Vue({
		...
		methods: {
			...
			getList: function () {
				...
				var url = baseUrl+"manage/app_ad/find_paged_infos.json";
			...
			handleDel: function (index, row) {
				this.$confirm('确认删除该记录吗？删除后不可恢复。', '提示', {
					...
					var self = this;
					this.listLoading = true;
					var url = baseUrl+"manage/app_ad/delete.json";
				...
				this.$refs.addForm.validate((valid) => {
					if (valid) {
						this.$confirm('确认提交吗？', '提示', {}).then(() => {
							...
							var url = baseUrl+"manage/app_ad/add.json";
				...
				this.$refs.editForm.validate((valid) => {
					if (valid) {
						this.$confirm('确认提交吗？', '提示', {}).then(() => {
							...
							var url = baseUrl+"manage/app_ad/update.json";
