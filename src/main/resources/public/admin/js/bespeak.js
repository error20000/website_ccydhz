...
var queryUrl = baseUrl + "api/bespeak/findPage";
var addUrl = baseUrl + "api/bespeak/add";
var modUrl = baseUrl + "api/bespeak/update";
var delUrl = baseUrl + "api/bespeak/delete";
var excelUrl = baseUrl + "api/bespeak/excel";
