...
var queryUrl = baseUrl + "api/background/findPage";
var addUrl = baseUrl + "api/background/add";
var modUrl = baseUrl + "api/background/update";
var delUrl = baseUrl + "api/background/delete";
