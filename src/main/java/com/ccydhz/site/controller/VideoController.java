...
public class VideoController extends BaseController<Video> {
	...
	@API(name="新增", 
		...
		request={
				...
				@ParamsInfo(name="ogg", type="String", isNull=0,  info="h5OGG"),
				@ParamsInfo(name="mp4", type="String", isNull=0,  info="h5MP4"),
				@ParamsInfo(name="webm", type="String", isNull=0,  info="h5WEBM"),
