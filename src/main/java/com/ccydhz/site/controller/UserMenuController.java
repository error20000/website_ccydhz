...
@API(info="", entity={UserMenu.class})
public class UserMenuController extends BaseController<UserMenu> {
	...
	@API(name="新增", 
		...
		request={
				//add request
				@ParamsInfo(name="user", type="int", isNull=0,  info="用户id"),
				@ParamsInfo(name="menu", type="int", isNull=0,  info="用户的菜单id"),
		}, 
		response={
