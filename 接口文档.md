...
&ensp;&ensp; data：结果集
* ** 结果集Data说明 **：
&ensp;&ensp; active：中奖记录pid
&ensp;&ensp; config：中奖的奖品
&ensp;&ensp; giftCode：中奖的奖品的礼包码，如果为空表示礼包码已用完。
* ** 示例 **：
&ensp;&ensp; http://127.0.0.1:8085/api/active/save?phone=123456&info=
&ensp;&ensp; {"code": 1, "msg": "成功", "data": {active: 0, config: 0, giftCode:''}}
* ** 说明 **：
...
&ensp;&ensp; data：结果集
* ** 结果集Data说明 **：
&ensp;&ensp; 数组里的info属性保存的就是礼包码。
* ** 示例 **：
&ensp;&ensp; http://127.0.0.1:8085/api/active/actived?phone=123456
&ensp;&ensp; {"code": 1, "msg": "成功", "data": [{...},{...}...]}
